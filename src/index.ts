...
import { McpFridaServer, ServerConfig } from './server.js'; // Import McpFridaServer and ServerConfig
...
let mcpServer: McpFridaServer | null = null;
...
async function main() {
    ...
    let logLevel = LogLevel[argv.logLevel.toUpperCase() as keyof typeof LogLevel] ?? LogLevel.ERROR;
    if (argv.verbose) {
